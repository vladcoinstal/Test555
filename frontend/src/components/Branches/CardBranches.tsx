...
const CardBranches = ({
  ...
  const hasUpdatePermission = hasPermission(currentUser, 'UPDATE_BRANCHES');
        ...
        {!loading &&
          branches.map((item, index) => (
            ...
            >
              ...
              >
                <Link
                  href={`/branches/branches-view/?id=${item.id}`}
                ...
                <div className='ml-auto '>
                  <ListActionsPopover
                    onDelete={onDelete}
                    itemId={item.id}
                    pathEdit={`/branches/branches-edit/?id=${item.id}`}
                    pathView={`/branches/branches-view/?id=${item.id}`}
