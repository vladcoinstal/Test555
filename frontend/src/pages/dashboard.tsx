...
const Dashboard = () => {
  ...
  const [branches, setBranches] = React.useState('Loading...');
  ...
  const organizationId = currentUser?.branches?.id;
    ...
    <>
      ...
      <SectionMain>
        ...
        >
          ...
          {hasPermission(currentUser, 'READ_BRANCHES') && (
            <Link href={'/branches/branches-list'}>
              <div
                className={`${
                  corners !== 'rounded-full' ? corners : 'rounded-3xl'
                } dark:bg-dark-900 ${cardsStyle} dark:border-dark-700 p-6`}
